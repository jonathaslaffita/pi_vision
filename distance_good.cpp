...
inputVideo.open(0);
// vector<float> cameraMatrix{662.81531922 ,  0.     ,    462.46163531,  0.  ,       664.52337529 , 291.17616957,  0. ,           0.    ,       1. };
...
// vector<float> distCoeffs{-0.13983382 , 0.38984575, -0.00326045 , 0.00090355, -0.41180841};
// cout << cameraMatrix << endl;
// cout << distCoeffs << endl;

// Mat cameraMatrix = {{662.81531922 ,  0.     ,    462.46163531}, {  0.  ,       664.52337529 ,291.17616957}, {0.,           0.    ,       1.     }};
// Mat distCoeffs = {};
...
Mat rvecs;//(3,1,cv::DataType<double>::type);
Mat tvecs;//(3,1,cv::DataType<double>::type);
while (inputVideo.grab()) {
    ...
    if (ids.size() > 0) {
        ...
        // cout << corners2[1] << endl;
        // cout << corners3[1] << endl;
        // cout << cameraMatrix << endl;
        // cout << distCoeffs << endl;
        // cout << corners2 << "hi" << corners << "hi" << cameraMatrix << "hi" << distCoeffs << "hi" << endl;
